...
const Hero = () => (
  <section className={`${styles.yPaddings} sm:pl-16 pl-6 mt-[4rem]`}>
    <motion.div
    ...
    >
      <div className="flex justify-center items-center flex-col relative z-10">
        ...
        >
          <h2 className={styles.heroHeading}>Omniv3rse</h2>
        </motion.div>
      </div>
      <motion.div
      ...
      >
        ...
        <img src="/banner.jpg" alt="cover" className="w-full sm:h-[500px] h-[350px] object-cover rounded-tl-[140px] z-10 relative" />
        <a href="#explore">
